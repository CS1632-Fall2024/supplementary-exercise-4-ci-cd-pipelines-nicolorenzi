...
public class RentACatUnitTest {
	...
	public void testGetCatNullNumCats0() {
		...
		// Credit to Chapter 24 of A Friendly Introduction to Software Testing by Bill Laboon
		try {
	...
	public void testGetCatNumCats3() {
		...
		try {
			...
			m.setAccessible(true);
			Object ret = m.invoke(r, 2);
			Cat returned = (Cat) ret;
			assertNotNull(returned);
			assertEquals(2, returned.getId());
		}
		catch (NoSuchMethodException|IllegalAccessException|InvocationTargetException e) {
			System.err.println("Method does not exist.");
		}
	...
	public void testRentCatFailureNumCats3() {
		...
		String finalOut = lines[lines.length - 1] + "\n";
